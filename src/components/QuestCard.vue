...
<template>
  ...
  <div class="xp-tracker">
    <span class="xp"> {{ quest.xp }}</span> out of <span class="xp-max">{{ quest.xp_needed }}</span>
  </div>
  ...
  <div v-else>
    ...
    <h5>Quest Flavor</h5>
    Once per chapter when you're in focus, you can earn 1 XP for yourself and 1 for the quest when:
    <ul>
